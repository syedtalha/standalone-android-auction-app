package com.talhasyed.bidit.views;
...
/**
 * Created by Talha Syed on 6/23/15.
 */
public class CountDownTimerView extends AppCompatTextView {
    ...
    public void setTime(long milliSecondsAtEnd, long milliSecondsAtStart) {
        setTime(Long.valueOf(milliSecondsAtEnd) - System.currentTimeMillis());
    }
